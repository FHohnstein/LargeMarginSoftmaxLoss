...
def prepare_model() -> nn.Module:
    ...
    # --> https://ai-pool.com/a/s/end-to-end-pytorch-example-of-image-classification-with-convolutional-neural-networks
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), padding=(1, 1), bias=False)

    # add new classification layer
    model.fc = nn.Sequential(nn.Linear(512, 64, bias=True),
